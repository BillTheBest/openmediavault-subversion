...
/**
 * @class OMV.module.admin.service.subversion.Repository
 * @derived OMV.workspace.window.Form
 */
Ext.define("OMV.module.admin.service.subversion.Repository", {
...
/**
 * @class OMV.module.admin.service.subversion.Repositories
 * @derived OMV.workspace.grid.Panel
 */
Ext.define("OMV.module.admin.service.subversion.Repositories", {
	...
	uses : [
		"OMV.module.admin.service.subversion.Repository",
        "OMV.module.admin.service.subversion.Privileges" //
	],

	hidePagingToolbar : false,
	stateful          : true,
	stateId           : "9129057b-b2c0-4c48-a4c1-8c9b4fb54d7b",
	columns           : [{
        text      : _("Name"),
		sortable  : true,
		dataIndex : "name",
	...
	urlRenderer : function (val, cell, record, row, col, store) {
		var u = location.host + location.pathname + '/subversion/' + val;
	...
	onAddButton : function () {
		var me = this;
		Ext.create("OMV.module.admin.service.subversion.Repository", {
	...
	onPrivilegesButton : function () {
		...
		Ext.create("OMV.module.admin.service.subversion.Privileges", {
			uuid : record.get("uuid")
		}).show();
	},
...
Ext.define("OMV.module.admin.service.subversion.Privileges", {
	extend : "OMV.workspace.window.Grid",
	uses   : [
		"OMV.Rpc",
		"OMV.module.admin.service.subversion.Privileges.grid", //"OMV.grid.Privileges",
		"OMV.workspace.window.plugin.ConfigObject"
	],
	...
	gridClassName : "OMV.module.admin.service.subversion.Privileges.grid", //"OMV.grid.Privileges",
...
Ext.define("OMV.module.admin.service.subversion.Privileges.grid", {
...
OMV.WorkspaceManager.registerPanel({
	...
	text      : _("Repositories"),
	position  : 20,
	className : "OMV.module.admin.service.subversion.Repositories"
});
